...
\subsection{Application: Difference Amplifier}
\label{sec:differenceamp}

\begin{figure}[ht]
  \begin{center}
    \includegraphics{differenceamp.eps}
    \caption{Schematic of an op amp based difference amplifier.}
    \label{fig:differenceamp}
  \end{center}
\end{figure}

\emph{Matching the values of the two $R_1$ resistors and the two $R_2$
...
\begin{figure}[ht]
  \begin{center}
    ...
    \caption{Schematic of an op amp based Schmitt trigger.}
    \label{fig:schmitt}
  \end{center}
\end{figure}
