...
\begin{figure}[ht]
  \begin{center}
    \htmlimage{align='center'}{} \includegraphics{kirchhoffsigns.eps}
...
\begin{figure}[ht]
  \begin{center}
    \htmlimage{align='center'}{} \includegraphics{thevenin.eps}
...
\begin{figure}[ht]
  \begin{center}
    \htmlimage{align='center'}{} \includegraphics{acvdivider.eps}
    \caption{AC voltage divider between two linear devices, or
      networks of linear devices, with complex impedances $Z_1$ and
      $Z_2$.}
...
The real-valued amplitude of the output signal is the magnitude of the
phasor $\mathbf{V_{out}}$,
\begin{equation}
...
\begin{figure}[ht]
  \begin{center}
    \htmlimage{align='center'}{} \includegraphics{rlccircuit.eps}
...
\begin{figure}[ht]
  \htmlimage{align='center'}{}
  \begin{center}
    \scalebox{0.45}{ \includegraphics{rlcnr.eps} }
    \vspace{12 pt} \scalebox{0.45}{ \includegraphics{rlcres.eps} }
...
\begin{figure}[ht]
  \htmlimage{align='center'}{}
  \begin{center}
    \scalebox{0.45}{ \includegraphics{rlc_vout.eps} }
    \hspace{12 pt} \scalebox{0.45}{ \includegraphics{rlc_phi.eps} }
...
drop (and above the reverse breakdown voltage) is applied, an ideal
diode behaves essentially like an open switch or an infinite
...
breakdown in the reverse-bias region of Figure~\ref{fig:diodevi}. The
standard silicon diodes you will encounter in lab have forward voltage
drops of about 0.7~V, reverse breakdown voltages of 100-1000 V, and
leakage currents on the order of $10^{-8}$~A.
...
\begin{figure}[ht]
  ...
  \begin{center}
    ...
    \caption{Schematic symbols for (a) NPN and (b) PNP bipolar
      junction transistors with labels on the collector (C), base (B),
      and emitter (E). (c) The plastic TO-92 transistor package we
      will use in lab with pins labeled.}
...
applications. Here, we will focus on \textbf{bipolar junction
  transistors} (BJTs).  Transistors have three terminals called the
\textbf{emitter}, the \textbf{collector}, and the \textbf{base}. A BJT
consists of two p-type -- n-type junctions, like those in a diode. In
an NPN transistor, the base is p-type semiconductor, and the emitter
and collector are n-type. In a PNP transistor, the polarities are
reversed.
