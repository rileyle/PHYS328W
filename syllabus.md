...
Mondays 1:30 - 4:20 pm, Pfahler 013

![Common Emitter Amplifier Schematic](https://rileyle.github.io/PHYS328W/notes/commonemitter.png)
...
*If you need help or would like to talk with me outside of class, I am happy to meet! I do not post fixed office hours, but you can get a sense of my general availability from [my schedule](https://rileyle.github.io/schedule.html){:target="_blank"}. Please use my [Bookings page](https://outlook.office365.com/owa/calendar/LewRileyOfficeHours@ursinuscollege365.onmicrosoft.com/bookings/){:target="_blank"} to set up meetings with me. (Bookings will not offer same-day meetings. For those, please reach out by email or Teams chat.)*
## Course Description
...
Feedback loops—practicing applying ideas, receiving feedback on your work, and using that feedback to improve as needed—are an essential component of effective learning. There is a growing body of evidence that grades do not facilitate learning --- and can actually shut it down (see [Blum, Susan D., and Alfie Kohn. Ungrading, WVU Press, 2020](https://ursinuscollege.on.worldcat.org/search?sortKey=LIBRARY&databaseList=&queryString=au%3Ablum+ti%3AUngrading){:target="_blank"}). One reason for this is that assigning a grade can shut down feedback loops before a single cycle is complete.
...
I expect you to collaborate with each other on lab work. Not only can you get help when you need it, but you can help other people as well. Teaching is a very effective way to learn. While I expect collaboration, it is also important that you understand your work and articulate your reasoning clearly. All of the writing in your reports and final paper must be your own. 
...
I use Canvas [announcements](I use Canvas announcements for communication with the entire class, and email to communicate with individuals and groups. You can reach me by email or Teams Chat.) for communication with the entire class, and email to communicate with individuals and groups. You can reach me by email or Teams Chat. 
